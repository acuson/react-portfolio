        ...
        <h1 class="m-5">About Me</h1>
            <div class="card bg-light border-primary m-5">
                <div class="card-body container-fluid d-flex justify-content-between">
                    <img src="./src/assets/Headshot.jpg" alt="Alyssa's headshot" class="w-25 m-2"/>
        ...
        <div class="card-deck container-fluid d-flex">
            <div class="card bg-light border-primary m-5">
                <div class="card-body container-fluid d-flex row justify-content-center">
                    ...
                    <img src="./assets/meteo-melodies.PNG" alt="Meteo Melodies landing page"/>
            ...
            <div class="card bg-light border-primary m-5">
                <div class="card-body container-fluid d-flex row justify-content-center">
                    ...
                    <img src="./build/assets/btc.png" alt="Between the Covers landing page"/>
            ...
            <div class="card bg-light border-primary m-5">
                <div class="card-body container-fluid d-flex row justify-content-center">
                    ...
                    <img src="./assets/wds.PNG" alt="Work day Scheduler landing page"/>
